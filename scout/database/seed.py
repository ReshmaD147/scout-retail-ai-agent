...
PROMOTIONS = [
    ...
    },
    {
        ...
        "start_date": "2026-07-01", "end_date": "2026-07-31", "active": 1,
    },
    {
...
EXTERNAL_OFFERS = [
    ...
    {
        "offer_id": "EXT-OFF-010",
        "merchant_name": "CarryWell Demo",
        "external_product_id": "CW-BRIEF-430",
        "product_name": "Boardroom Slim Briefcase",
        "brand": "Boardroom",
        "category": "Bags",
        "description": "Executive laptop briefcase with a structured profile, office organizer, and padded sleeve.",
        "price": 74.99,
        "currency": "USD",
        "rating": 4.3,
        "review_count": 118,
        "availability_status": "in_stock",
        "attributes": {"color": "Black", "use_case": "executive office commute", "tags": ["briefcase", "executive", "office", "laptop"]},
        "image_url": None,
        "merchant_url": "https://example.com/?scout_offer=EXT-OFF-010",
        "upc": None,
        "gtin": None,
        "model_number": "BR-SB430",
        "active": 1,
    },
    {
